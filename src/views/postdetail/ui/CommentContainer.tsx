    ...
    return (
        <Container width='90%'>
            ...
            <ColumnWrapper gap='0.75em'>
                <RowWrapper>
                    <UserInfo name={commentData.commentUser} department={commentData.department}
                        enterYear={commentData.enterYear} imgUrl={ProfileExample}/>
                </RowWrapper>
                ...
                <RowWrapper gap='0.5em'>
                    ...
                    {isReply && (
                        <OpenClose>
                            {isClosed ? `${commentData.reply.length}개의 답글` : '숨기기'}
                        </OpenClose>
                    )}
                </RowWrapper>
            </ColumnWrapper>
                ...
                <ReplyList>
                    {commentData.reply.map((reply) => (             
                        <ReplyContainer key={reply.replyId}>
                            <UserInfo name={reply.replyUser} department={reply.department}
                                enterYear={reply.enterYear} imgUrl={ProfileExample}/>
